module.exports = function (hexo) {
    ...
    hexo.extend.helper.register('page_nav', function (page = null) {
        ...
        const sidebar = hexo.theme.config.sidebar[page.lang] && hexo.theme.config.sidebar[page.lang][page.type];
        if (!sidebar) {
            return '';
        }
        ...
        if (sidebar.level === 1) {
            ...
            for (const children of Object.values(sidebar.items)) {
        ...
        const index = sidebarLinkArr.findIndex((link, itemIndex) => {
            return link === url_for(path) && sidebarNameArr[itemIndex] === page.title;
        });
